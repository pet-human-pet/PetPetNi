  ...
  >
    ...
    >
      ...
      >
        ...
        >
          <div
            class="sticky top-10 z-40 -mx-2 flex-none border-b border-gray-100 bg-transparent px-2 min-[800px]:top-17.5 md:-mx-4 md:px-4 lg:static lg:z-auto lg:mx-0 lg:rounded-t-3xl lg:border-b-0 lg:bg-white lg:px-0"
          >
