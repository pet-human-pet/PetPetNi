...
<template>
  ...
  >
    <div
      class="rounded-xl border-2 border-dashed border-[#ff9f43] bg-white p-4
    ...
    <ul class="list-none p-0 m-0 flex flex-col gap-3.75 max-[800px]:contents">
      ...
      >
        <div class="p-3.75 max-[800px]:p-3">
          <span class="mb-1 inline-block rounded-sm bg-[#e3f2fd] px-2 py-0.5 text-[11px] text-[#2196f3]">
            團購
          </span>
          <div class="mb-1 text-[16px] font-bold">{{ gb.title }}</div>
